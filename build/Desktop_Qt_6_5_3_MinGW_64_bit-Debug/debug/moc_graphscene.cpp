...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGraphSceneENDCLASS_t qt_meta_stringdata_CLASSGraphSceneENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 25),  // "QGraphicsSceneMouseEvent*"
        QT_MOC_LITERAL(51, 5),  // "event"
        QT_MOC_LITERAL(57, 10),  // "mouseMoved"
        QT_MOC_LITERAL(68, 13)   // "mouseReleased"
    },
    "GraphScene",
    "mousePressed",
    "",
...
void GraphScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mousePressed((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        case 1: _t->mouseMoved((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        case 2: _t->mouseReleased((*reinterpret_cast< std::add_pointer_t<QGraphicsSceneMouseEvent*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GraphScene::*)(QGraphicsSceneMouseEvent * );
            if (_t _q_method = &GraphScene::mousePressed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GraphScene::*)(QGraphicsSceneMouseEvent * );
            if (_t _q_method = &GraphScene::mouseMoved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GraphScene::*)(QGraphicsSceneMouseEvent * );
            if (_t _q_method = &GraphScene::mouseReleased; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void GraphScene::mousePressed(QGraphicsSceneMouseEvent * _t1)
{
...
// SIGNAL 1
void GraphScene::mouseMoved(QGraphicsSceneMouseEvent * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void GraphScene::mouseReleased(QGraphicsSceneMouseEvent * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
